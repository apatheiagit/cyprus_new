<?php foreach ($fields as $id => $field): 
    ...
    if($id == 'type') { $content_type = $field->content; }
    ...
    if($id == 'field_heading') {$teaser = $field->content;}
 endforeach; ?>
<?php 	
...
<div class="media-block media-block--review <?php if(isset($rubric_type)):?>media-block--rubric<?endif;?> media-block--<?php print $type;?> media-block--<?php print $english;?>">
	...
	<div class="text">		
		...
		<?php endif;?>
		<div class="category">
		<?php if($content_type == 'lifestyle'):?>
			<a href="<?php print $prefix;?>/lifestyle"><?php print t('lifestyle');?></a>
		<?php endif;?>
